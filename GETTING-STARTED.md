...
`Tab` moves around, `?` is help, `Esc` cancels a form without submitting, `q` quits. Sending mail or changing a calendar still shows an exact preview before anything is sent.
